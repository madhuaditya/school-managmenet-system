...
//           <View style={styles.fullscreenMeta}>
//             <Text style={styles.studentNameFull}>{item.name}</Text>
//             <Text style={styles.studentMeta}>Roll {item.rollNumber || 'N/A'} · {item.studentIdCode || 'No ID'}</Text>
//             <Text style={styles.studentMeta}>{item.email || 'N/A'}</Text>
//             <Text style={styles.studentMeta}>{item.fatherName ? `Father: ${item.fatherName}` : 'Father: N/A'}</Text>
//             <Text style={styles.studentMeta}>{item.motherName ? `Mother: ${item.motherName}` : 'Mother: N/A'}</Text>
//           </View>

//           <View style={[styles.statusBadge, renderStatusBadge(item.currentStatus)]}>
//             <Text style={styles.statusBadgeText}>{renderStatusLabel(item.currentStatus)}</Text>
//           </View>
//         </View>

//         <View style={styles.fullscreenHintCard}>
//           <Text style={styles.hintText}>Swipe up to mark present and go next. Swipe down to mark absent and go next.</Text>
//         </View>
...
//   return (
//     <View style={[styles.rosterRow, rowTint]}>
//       <View style={styles.rowHeader}>
//         {item.image ? (
//           <Image source={{ uri: item.image || AVATAR_FALLBACK }} style={styles.avatar} />
//         ) : (
...
//       <View style={styles.rowParentInfo}>
//         <Text style={styles.parentText}>Father: {item.fatherName || 'N/A'}</Text>
//         <Text style={styles.parentText}>Mother: {item.motherName || 'N/A'}</Text>
//       </View>
