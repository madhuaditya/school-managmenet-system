  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <TouchableOpacity
          style={[styles.actionBtn, saving && styles.disabledBtn]}
          disabled={saving}
          onPress={handleUpdate}>
          {saving ? (
        ...
        <TouchableOpacity
          ...
          <ThemedText style={styles.secondaryBtnText}>My Attendance</ThemedText>
        </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  changePhotoBtn: {
    ...
    backgroundColor: 'rgba(118, 171, 174, 0.1)', // Light tint of Accent
    borderRadius: 4,
    minHeight: 36,
  ...
  addressWrapper: {
    // Styling applied if AddressLookupField doesn't manage its own background properly
    backgroundColor: PALETTE.surface,
  },
  label: {
    fontSize: 12,
  ...
  logoutBtn: {
    ...
    backgroundColor: 'rgba(211, 47, 47, 0.05)', // Light tint of Error
    marginTop: 12,
  },
  logoutText: {
    color: PALETTE.error,
