  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.summaryCard}> 
        ...
        <Text style={styles.summaryText}>Total Marked: <Text style={styles.summaryValue}>{summary?.total ?? computed.marked}</Text></Text>
        <Text style={styles.summaryText}>Present: <Text style={styles.summaryValue}>{summary?.present ?? computed.present}</Text></Text>
        <Text style={styles.summaryText}>Absent: <Text style={styles.summaryValue}>{summary?.absent ?? computed.absent}</Text></Text>
        <Text style={styles.summaryText}>Leave: <Text style={styles.summaryValue}>{summary?.leave ?? computed.leave}</Text></Text>
      </View>
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  chartDot: {
    width: 10,
    height: 10,
    borderRadius: 2, // Squarish to fit theme
  },
  chartLabel: {
    fontSize: 13,
    fontWeight: '600',
